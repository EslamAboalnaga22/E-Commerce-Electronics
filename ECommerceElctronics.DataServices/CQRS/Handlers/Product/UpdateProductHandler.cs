...
{
    public class UpdateProductHandler(IUnitOfWork unitOfWork, IMapper mapper, IWebHostEnvironment environment) : IRequestHandler<UpdateProductCommand, Result<bool>>
    {
